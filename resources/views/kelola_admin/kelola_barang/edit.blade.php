...
@section('admin')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="{{ route('barang_edit', $edit->id_kelola_barang) }}" method="POST">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode_barang" value="{{ $edit->kode_barang }}" id=""
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_barang" id="" value="{{ $edit->nama_barang }}"
